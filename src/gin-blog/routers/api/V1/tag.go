...
func AddTag(c *gin.Context) {
	...
	valid.MaxSize(name, 100, "name").Message("名称最大长度不超过100")
	valid.Required(createBy, "created_by").Message("创建人不能为空")
	valid.MaxSize(createBy, 100, "created_by").Message("创建人最大长度不能超过100")
	valid.Range(state, 0, 1, "state").Message("状态只能0、1")
